...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "JAG helps enterprises, governments and universities transform with custom software, AI, cloud, cybersecurity and infrastructure — engineered end-to-end." },

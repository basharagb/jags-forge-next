...
import {
  ...
  Mail, Phone, MapPin, Facebook, Send,
} from "lucide-react";
...
import { SERVICES, WHY, STATS, INDUSTRIES, TECHS, TESTIMONIALS, PARTNERS, SOLUTIONS } from "@/lib/content";
      ...
      <div className="container-x grid gap-12 lg:grid-cols-2">
        <div>
          ...
          <div className="mt-10 space-y-4">
            <a href="mailto:info@jag.jo" className="flex items-center gap-4 group">
              ...
              <span className="text-foreground/85 group-hover:text-[var(--emerald-brand)] transition-colors" dir="ltr">info@jag.jo</span>
            </a>

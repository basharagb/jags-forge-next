...
// Single-page site: every nav item scrolls to a section on the homepage.
const NAV = [
  { href: "/#about", k: "label.about" },
  { href: "/#services", k: "label.services" },
  { href: "/#solutions", k: "label.solutions" },
  { href: "/#industries", k: "label.industries" },
  { href: "/#clients", k: "label.clients" },
  { href: "/#contact", k: "label.contact" },
] as const;
...
export function Header() {
  ...
  // The homepage renders a dark gradient hero under the fixed header, so at the top
